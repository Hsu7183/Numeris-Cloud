(() => {
  ...
  button.addEventListener("click", async () => {
    ...
    try {
      const response = await fetch("/api/daily539/recent?limit=200");
      ...
      document.querySelector("#xlsx-output-link").classList.remove("hidden");
      document.querySelector("#period-grid-link").classList.remove("hidden");
      document.querySelector("#historical-period-grid-link").classList.remove("hidden");
      document.querySelector("#pattern-grid-link").classList.remove("hidden");
      document.querySelector("#pattern-template-link").classList.remove("hidden");
